...
class MainStandardController extends Controller
{
    ...
    public function create()
    {
        $mainStandards =  MainStandard::with(['subStandards.criteria'])->get();
        // dd( $mainStandards);
        return view('main_standards.create', compact('mainStandards'));
    }
    ...
    public function show(MainStandard $mainStandard)
    {
        ...
        return view('main_standards.show', compact('mainStandard', 'subStandards'));
    }
    /**
    ...
    {
        return view('main_standards.edit', compact('mainStandard'));
    }
