...
class CriterionController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('criteria.create', compact('mainStandards', 'subStandards'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('criteria.edit', compact('criteria', 'Standards'));
    }
    ...
    public function update(Request $request, Criterion $criterion)
    {
        ...
        // Validate the request
        $validated = $request->validate([
            'standard_id' => 'required', // Ensure valid standard ID
            'standard_type' => 'required|in:main,sub', // Validate enum values
            'name_ar' => 'required|string|max:255',
            'name_en' => 'required|string|max:255',
            'content_ar' => 'nullable|string',
            'content_en' => 'nullable|string',
