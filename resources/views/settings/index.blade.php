        ...
        @if (Auth::user()->type == 'super admin')
            <li class="nav-item">
                <a class="nav-link" id="brand_settings-tab" data-bs-toggle="pill" href="#brand_settings" role="tab"
                    aria-controls="brand_settings" aria-selected="false">{{ __('General Settings') }}</a>
            </li>

            <li class="nav-item">
                <a class="nav-link" id="facility_settings-tab" data-bs-toggle="pill" href="#facility_settings"
                    role="tab" aria-controls="facility_settings" aria-selected="false">{{ __('Facility Info') }}</a>
            </li>

            {{-- <li class="nav-item">
                <a class="nav-link" id="contact_settings-tab" data-bs-toggle="pill" href="#بياناتبيانات" role="tab"
                    aria-controls="contact_settings" aria-selected="false">{{ __('Contact Info') }}</a>
            </li> --}}
                ...
                @if (Auth::user()->type == 'super admin')
                    ...
                    <div class="tab-pane fade" id="facility_settings" role="tabpanel"
                        ...
                        <div class="card" id="facility_settings">
                            <form action="{{ route('Facility.setting') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="card-header">
                                    <h5 class="mb-2">{{ __('Facility Info') }}</h5>
                                </div>
                                <div class="card-body">
                                    <!-- Tabs -->
                                    ...
                                    <div class="tab-content mt-3" id="facilityTabsContent">
                                        ...
                                        <div class="tab-pane fade show active" id="arabic" role="tabpanel"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="vision_ar" class="form-control summernote" rows="3" placeholder="{{ __('Enter Vision (Arabic)') }}">{{ $settings['vision_ar'] ?? '' }}</textarea>
                                            </div>
                                            <div class="form-group">
                                                <label  class="form-label">{{ __('Goals (Arabic)') }}</label>
                                                <textarea name="goals_ar" class="form-control summernote" rows="3" placeholder="{{ __('Enter Goals (Arabic)') }}">{{ $settings['goals_ar'] ?? '' }}</textarea>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="tab-pane fade"  id="english" role="tabpanel"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="vision_en" class="form-control summernote" rows="3" placeholder="{{ __('Enter Vision (English)') }}">{{ $settings['vision_en'] ?? '' }}</textarea>
                                            </div>
                                            <div class="form-group">
                                                <label  class="form-label">{{ __('Goals (English)') }}</label>
                                                <textarea name="goals_en" class="form-control summernote" rows="3" placeholder="{{ __('Enter Goals (English)') }}">{{ $settings['goals_en'] ?? '' }}</textarea>
                                            </div>
                                            <div class="form-group">
                    ...
                    <div class="tab-pane fade" id="email_settings" role="tabpanel" aria-labelledby="email_settings-tab">
                        <div class="card" id="email_settings">
                            ...
                            <div class="card-header">
                                ...
                                <span
                                    class="text-muted">{{ __('(This SMTP will be used for system-level email sending. Additionally, if a owner user does not set their SMTP, then this SMTP will be used for sending emails.)') }}</span>
                            </div>
                            <div class="card-body">
                                <div class="row">
