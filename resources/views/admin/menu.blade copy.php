                    ...
                    @if (Gate::check('manage user') || Gate::check('manage role') || Gate::check('manage logged history'))
                        <li
                            ...
                            <a href="#!" class="pc-link">
                                ...
                                <span class="pc-mtext">{{ __('Customer managment') }}</span>
                            ...
                            <ul class="pc-submenu"
                                ...
                                @if (Gate::check('manage user'))
                                    <li class="pc-item {{ in_array($routeName, ['users.index']) ? 'active' : '' }}">
                                        <a class="pc-link" href="{{ route('users.index') }}">{{ __('Customers') }}</a>
                                    </li>
                                @endif
                                @if (Gate::check('manage user'))
                                    <li class="pc-item {{ in_array($routeName, ['users.index']) ? 'active' : '' }}">
                                        <a class="pc-link" href="{{ route('users.index') }}">{{ __('Consultants') }}</a>
                                    </li>
                                @endif
                                @if (Gate::check('manage role'))
                                    <li
