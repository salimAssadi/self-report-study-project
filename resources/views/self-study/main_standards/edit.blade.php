...
@section('content')
    ...
    <div class="row">
        <!-- [ sample-page ] start -->
        <div class="col-sm-12">
            {{ Form::model($standard, ['method' => 'put', 'id' => 'frmTarget', 'enctype' => 'multipart/form-data', 'route' => ['admin.main-standards.update', $standard->id]]) }}
            @csrf
            @method('PUT')    
            <div class="row">
                <div class="col-lg-12">
                    <div class="card shadow-none border border-primary">
                        <div class="card-header">
                            <div class="row align-items-center g-2">
                                ...
                                <div class="col-auto">
                                    ...
                                    <a href="{{ route('admin.main-standards.index') }}" class="btn btn-light-secondary me-3"> <i data-feather="x-circle"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                {{ Form::select('type', ['main' => __('Main Standard'), 'sub' => __('Sub-Standard')], 'main', ['class' => 'form-control', 'id' => 'type', 'onchange' => 'toggleSubStandardFields()']) }}
                            </div>
                            ...
                            <div id="sub-standard-field" class="form-group d-none ">
                                ...
                                {{ Form::select('main_standard_id', $mainStandards->pluck('name_ar', 'id'), $standard->id, ['class' => 'form-control']) }}
                            </div>

                            <!-- Sequence -->
                            <div class="form-group">
                                {{ Form::label('sequence', __('Sequence'), ['class' => 'form-label']) }}
                                {{ Form::number('sequence', $standard->sequence, ['class' => 'form-control', 'placeholder' => __('Enter Sequence'), 'step' => '0.1']) }}
                            </div>
                            ...
                            <div class="tab-content" id="languageTabsContent">
                                ...
                                <div class="tab-pane fade show active" id="ar-fields" role="tabpanel"
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        {{ Form::text('name_ar', $standard->name_ar, ['class' => 'form-control ', 'placeholder' => __('Enter Name (Arabic)')]) }}
                                    </div>
                                    <div class="form-group  main-standard-field">
                                        {{ Form::label('introduction_ar', __('Introduction (Arabic)'), ['class' => 'form-label']) }}
                                        {{ Form::textarea('introduction_ar', $standard->introduction_ar, ['class' => 'form-control summernote', 'rows' => 2, 'placeholder' => __('Enter Introduction (Arabic)')]) }}
                                    </div>

                                    <div class="form-group">
                                        {{ Form::label('description_ar', __('Description (Arabic)'), ['class' => 'form-label']) }}
                                        {{ Form::textarea('description_ar',  $standard->description_ar, ['class' => 'form-control summernote', 'rows' => 2, 'placeholder' => __('Enter Description (Arabic)')]) }}
                                    </div>
                                    <div class="form-group  main-standard-field">
                                        {{ Form::label('summary_ar', __('Summary (Arabic)'), ['class' => 'form-label']) }}
                                        {{ Form::textarea('summary_ar', $standard->summary_ar, ['class' => 'form-control summernote', 'rows' => 2, 'placeholder' => __('Enter Summary (Arabic)')]) }}
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="en-fields" role="tabpanel" aria-labelledby="en-tab">
                                    <div class="form-group  mt-3">
                                        ...
                                        {{ Form::text('name_en', $standard->name_en, ['class' => 'form-control', 'placeholder' => __('Enter Name (English)')]) }}
                                    </div>
                                    <div class="form-group  main-standard-field">
                                        {{ Form::label('introduction_en', __('Introduction (English)'), ['class' => 'form-label']) }}
                                        {{ Form::textarea('introduction_en',  $standard->introduction_en, ['class' => 'form-control summernote', 'rows' => 2, 'placeholder' => __('Enter Introduction (English)')]) }}
                                    </div>

                                    <div class="form-group">
                                        {{ Form::label('description_en', __('Description (English)'), ['class' => 'form-label']) }}
                                        {{ Form::textarea('description_en',  $standard->description_en, ['class' => 'form-control summernote', 'rows' => 2, 'placeholder' => __('Enter Description (English)')]) }}
                                    </div>
                                    <div class="form-group  main-standard-field">
                                        {{ Form::label('summary_en', __('Summary (English)'), ['class' => 'form-label']) }}
                                        {{ Form::textarea('summary_en',  $standard->summary_en, ['class' => 'form-control summernote', 'rows' => 2, 'placeholder' => __('Enter Summary (English)')]) }}
                                    </div>
