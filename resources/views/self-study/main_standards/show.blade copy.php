                    ...
                    <div class="card border border-primary shadow-none">
                        <div class="card-body">
                            <div
                                ...
                                <h4>{{ $criteria->name_ar }}</h4>
                                <div class="ps-3 d-flex align-items-center ">
                                    <span
                                        class="badge rounded p-2 f-w-600  bg-light-dark">{{ __('ID: #') }}{{ $criteria->SKU }}
                                    </span>
                            ...
                            <div class="border  mb-4 rounded border-primary">
                                @if (!empty($criteria->id))
                                    <a class="d-block"
                                        href="{{ $logo . (isset($criteria->id) && !empty($criteria->id) ? $criteria->id : 'default_img.png') }}"
                                        target="_blank" data-fancybox="product">
                                        <img class="m-auto d-block w-50"
                                            src="{{ $logo . (isset($criteria->id) && !empty($criteria->id) ? $criteria->id : 'default_img.png') }}"
                                            alt="">
                                    </a>
                                @else
                                    <img src="{{ $logo . (isset($criteria->id) && !empty($criteria->id) ? $criteria->id : 'default_img.png') }}"
