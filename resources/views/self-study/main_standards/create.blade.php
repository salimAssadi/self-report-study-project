...
@section('content')
    ...
    <div class="row">
        <!-- [ sample-page ] start -->
        <div class="col-sm-12">
            {{ Form::open(['method' => 'post', 'id' => 'frmTarget', 'enctype' => 'multipart/form-data', 'route' => 'admin.main-standards.store']) }}
            @csrf
            <div class="row">
                <div class="col-lg-12">
                    <div class="card shadow-none border border-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div id="sub-standard-field" class="form-group d-none ">
                                ...
                                {{ Form::select('main_standard_id', $mainStandards->pluck('name_ar', 'id'), null, ['class' => 'form-control']) }}
                            </div>
