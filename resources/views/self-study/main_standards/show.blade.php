                                ...
                                @else
                                    @foreach ($subStandards as $subStandard)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.sub-standards.show', $subStandard->id) }}"
                                                    class="btn btn-sm btn-icon  bg-light-secondary me-2">
                                                    <i class="ti ti-eye f-20"></i>
                                                </a>
                                                <a href="{{ route('admin.sub-standards.edit', $subStandard->id) }}"
                                                    class="btn btn-sm btn-icon bg-light-secondary me-2">
                                                    <i class="ti ti-edit f-20"></i> </a>
                                                <form action="{{ route('admin.sub-standards.destroy', $subStandard->id) }}"
