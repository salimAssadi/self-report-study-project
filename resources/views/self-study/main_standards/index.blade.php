            ...
            <div class="card table-card">
                <div class="card-header">
                    <div class="row align-items-center g-2">
                        ...
                        <div class="col-auto">
                            <a href="{{ route('admin.main-standards.create') }}" class="btn btn-secondary customModal"
                        ...
                        <table class="table table-hover advance-datatable">
                            ...
                            <tbody>
                                @foreach ($standards as $standard)
                                    <!-- Parent Row -->
                                    <tr data-toggle="collapse" data-target="#children-{{ $standard->id }}"
