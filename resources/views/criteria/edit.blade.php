...
@section('action-btn')
    <div class="pr-2">
        ...
        <a href="{{ route('criteria.index') }}" class="btn btn-light-secondary me-3"> <i data-feather="x-circle"
...
@section('content')
    <div class="row">
        <!-- [ sample-page ] start -->
        <div class="col-sm-12">
            {{ Form::open(['method' => 'PUT', 'route' => ['criteria.update', $criteria], 'enctype' => 'multipart/form-data']) }}
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-lg-12">
