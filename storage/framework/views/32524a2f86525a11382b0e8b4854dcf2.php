                        ...
                        <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><label class="ischeck form-label"
                                        data-id="<?php echo e(str_replace(' ', '', $module)); ?>"><?php echo e(__(ucfirst($module))); ?></label>
                                </td>
                                <td>
                                    <div class="row">
                                        <?php if(in_array('Manage ' . $module, (array) $permissions)): ?>
                                            <?php if($key = array_search('Manage ' . $module, $permissions)): ?>
                                                <div class="col-md-3 custom-control custom-checkbox">
                                                    ...
                                                    <?php echo e(Form::label('permission' . $key, __('Manage'), ['class' => 'form-label font-weight-500'])); ?><br>
                                                </div>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                        <?php if(in_array('Create ' . $module, (array) $permissions)): ?>
                                            <?php if($key = array_search('Create ' . $module, $permissions)): ?>
                                                <div class="col-md-3 custom-control custom-checkbox">
                                                    ...
                                                    <?php echo e(Form::label('permission' . $key, __('Create'), ['class' => 'form-label font-weight-500'])); ?><br>
                                                </div>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                        <?php if(in_array('Edit ' . $module, (array) $permissions)): ?>
                                            <?php if($key = array_search('Edit ' . $module, $permissions)): ?>
                                                <div class="col-md-3 custom-control custom-checkbox">
                                                    ...
                                                    <?php echo e(Form::label('permission' . $key, __('Edit'), ['class' => 'form-label font-weight-500'])); ?><br>
                                                </div>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                        <?php if(in_array('Delete ' . $module, (array) $permissions)): ?>
                                            <?php if($key = array_search('Delete ' . $module, $permissions)): ?>
                                                <div class="col-md-3 custom-control custom-checkbox">
                                                    ...
                                                    <?php echo e(Form::label('permission' . $key, __('Delete'), ['class' => 'form-label font-weight-500'])); ?><br>
                                                </div>
                                            <?php endif; ?>
                                        <?php endif; ?>
...
<?php /**PATH D:\XAMPP\htdocs\whatsstore_saas\resources\views/roles/create.blade.php ENDPATH**/ ?>