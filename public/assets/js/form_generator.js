        ...
        return `
            <div class="form-group">
                <div class="input-group">
                    ...
                    <button type="button" class="btn btn-danger input-group-text removeOption"><i class="ti ti-trash"></i></button>
                </div>
            </div>
        `;
    }
        ...
        var formsHtml = `
            ...
            <div class="card-body">
                ...
                <div class="btn-group w-100">
                    <button type="button" class="btn btn-primary editFormData" data-form_item='${JSON.stringify(formItem)}' data-update_id="${updateId}"><i class="ti ti-edit"></i></button>
                    <button type="button" class="btn btn-danger removeFormData"><i class="ti ti-trash"></i></button>
                </div>
            </div>
        `;
        var html = `
